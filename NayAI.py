...
# =============================================================================
# PROJET : NAYIA 2.0 - L'INTELLIGENCE ARTIFICIELLE MODULABLE
# AUTEUR ORIGINAL : [Nayane Ahamadi @NayCode]
# VERSION : 2.0 (DEFI 10 JOURS)
...
logo = """
 ...
 |_| \_| \__,_| \__, | |___/_/   \_\  |_____|
                |___/                               
      >> SYSTEME NAYIA VERSION 2.0 CHARGE <<
      >> DEVELOPPEUR : NAYANE             <<
      >> STATUT : OPERATIONNEL            <<
----------------------------------------------------------------------------
"""

# On affiche le logo au demarrage
...
print("======== NayIA 2.0 ========")
print("Tape 'stop' pour quitter.Tape /aide pour cmds")
...
while True:
    ...
    # 3. Logique reponse
        ...
        print("NayIA :", random.choice(reponses))
            ...
            import random
            print("NayIA 2.0 - Suggestion de film :")
        ...
        if "/stats" in question:
            ...
            print("====== PARAMETRES NAYIA 2.0 ======")
            print("NayAI : Paramètres -> Version: 2.0 | Développeur: Nayane Ahamadi @Naycode | Mode: Apprentissage Actif")
            ...
            - /version : Affiche la version actuelle (2.0) et le changelog.
            ...
            NayIA 2.0 est une IA hors-ligne. Elle ne peut pas naviguer sur internet
            ...
            import platform
            import datetime
            print("--- ANALYSE SYSTEME NAYIA 2.0 ---")
        ...
        print("NayIA :", random.choice(geo_data))
            ...
            import random
            print("NayIA 2.0 - Decouverte du monde :")
        ...
        print("--- CONDITIONS GENERALES D'UTILISATION ---")
        print("ARTICLE 1 : OBJET DES CGULes presentes Conditions Generales d'Utilisation ont pour objet de definir les modalites de mise a disposition du logiciel NayIA 2.0 et les conditions d'utilisation du systeme par l'utilisateur final. Tout acces au programme implique l'acceptation des CGU.ARTICLE 2 : ACCES AU SYSTEMENayIA 2.0 est accessible gratuitement a tout utilisateur disposant d'un interpreteur Python 3. Le developpeur s'efforce de maintenir le script fonctionnel mais ne peut garantir une absence totale de bugs techniques.ARTICLE 3 : COLLECTE DES DONNEESLe logiciel NayIA 2.0 ne collecte aucune donnee personnelle a l'insu de l'utilisateur.Les seules donnees enregistrees sont les paires de questions/reponsesstockees dans le fichier local memoire.json. Ce fichier appartient a l'utilisateur et reste sur sa machine physique. Aucune transmission reseau n'est effectuee.ARTICLE 4 : RESPONSABILITE DE L'UTILISATEURL'utilisateur est responsable des contenus qu'il choisit d'apprendre a l'IA via la commande /learn. Il est interdit d'utiliser NayIA 2.0 pour generer ou stockerdes contenus haineux, illegaux ou dangereux. Le developpeur decline toute responsabilite en cas de mauvaise utilisation du mode apprentissage.ARTICLE 5 : PROPRIETE ET MODIFICATIONLe code source est libre de modification pour un usage prive. Toute redistribution commerciale sans mention du developpeur original est interdite. L'utilisateur est encourage a contribuer a l'augmentation de la base de donnees (ko).ARTICLE 6 : EVOLUTION DU CONTRATLe developpeur se reserve le droit de modifier les termes de ce contrat a tout moment pour les futures versions (ex: version 3.0). L'utilisation continue du logiciel apres modification vaut acceptation des nouveaux termes.ARTICLE 7 : SUPPRESSION DE COMPTE (LOBOTOMIE)L'utilisateur peut a tout moment reinitialiser l'IA via la commande /cleanjson. Cela entraine la suppression immediate et definitive de toutes les donnees apprises par le systeme depuis sa premiere installation.---------------------------------------------------------------------------------------")
        
    elif "/version" in question:
        print("NayIA Version 2.0")
...
# EN UTILISANT NAYIA 2.0, VOUS ACCEPTEZ LES TERMES SUIVANTS :

licence_texte = """
1. DEFINITIONS DU SYSTEME
Le logiciel NayIA 2.0 est une intelligence artificielle de traitement de donnees locale.
...
Le code source de NayIA 2.0 est la propriete exclusive du developpeur original.
...
NayIA 2.0 stocke les informations dans un fichier nomme memoire.json.
...
L'intelligence de NayIA 2.0 evolue selon les interactions de l'utilisateur.
...
L'utilisation de NayIA 2.0 implique l'acceptation sans reserve de ce document.
...
NayIA 2.0 est accessible gratuitement a tout utilisateur disposant d'un interpreteur 
...
Le logiciel NayIA 2.0 ne collecte aucune donnee personnelle a l'insu de l'utilisateur.
...
la commande /learn. Il est interdit d'utiliser NayIA 2.0 pour generer ou stocker 
